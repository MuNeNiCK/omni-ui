...
export default function SliderDemo() {
  return (
    <Card class="border-border/70">
      <CardHeader>
        <CardTitle class="text-sm font-medium text-muted-foreground">Capacity</CardTitle>
        <CardDescription>Used for intensity controls and resource allocations.</CardDescription>
      </CardHeader>
      <CardContent class="space-y-6">
        <div class="space-y-2">
          <span class="text-xs font-medium text-muted-foreground/80">Storage</span>
          <Slider defaultValue={[60]} maxValue={100} step={5} />
        </div>
        <div class="space-y-2 opacity-60">
          <span class="text-xs font-medium text-muted-foreground/70">Throughput</span>
