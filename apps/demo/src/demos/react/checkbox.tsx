    ...
    <Card className="border-border/70">
      ...
      <CardContent className="grid gap-3">
        <label className="group/field flex items-center gap-3">
          ...
          <span className="text-xs font-medium text-muted-foreground/90">Alerts</span>
        </label>
        <label className="group/field flex items-center gap-3">
          <Checkbox id="reports" />
          <span className="text-xs font-medium text-muted-foreground/90">Weekly reports</span>
        </label>
        <label className="group/field flex items-center gap-3 opacity-50">
          <Checkbox id="beta" disabled />
          <span className="text-xs font-medium text-muted-foreground/70">Beta features</span>
        </label>
      </CardContent>
    </Card>
  );
