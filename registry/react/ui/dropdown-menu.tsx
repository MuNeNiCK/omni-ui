  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        variant === "destructive" && "text-destructive hover:bg-destructive hover:text-background",
        inset && "pl-9",
        className,
      )}
      {...props}
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn("ml-auto text-muted-foreground/70", omniMonoText.wide, className)}
      {...props}
    />
  );
}
